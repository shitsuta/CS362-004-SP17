...
int main() {
	...
	//Check State Change
	originalAssert("Error on numBuys", G.numBuys + 1 == testG.numBuys, &bugs);
	originalAssert("Error on handCount", G.handCount[thisPlayer] + 4 - 1 == testG.handCount[thisPlayer], &bugs);
