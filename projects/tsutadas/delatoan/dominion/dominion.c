...
int newAdventurer(int drawntreasure, struct gameState* state, int currentPlayer, int* temphand, int z, int cardDrawn) {
...
int newCouncil_room(int i, int currentPlayer, struct gameState *state, int handPos) {
	for (i = 0; i < 4; i++)
	{
		drawCard(currentPlayer, state);
	}
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
		return newAdventurer(drawntreasure, state, currentPlayer, temphand, z, cardDrawn);
			
    case council_room:
		return newCouncil_room(i, currentPlayer, state, handPos);
    ...
    case steward:
		return newSteward(choice1, choice2, choice3, currentPlayer, state, handPos);
